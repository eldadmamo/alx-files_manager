...
class FilesController {
  ...
  /**
   *  retrieve all users file documents specific
   * Pagination can be done directly by MongoDB
   */
  ...
  /**
   *  set's isPublic to true on the file document based on ID
   * And return file document status code 200
   */
  ...
  /**
   * return content file document based on ID
   */
